...
const makeQuotesRouter = require('./routes/quotes'); // ← quotes module
...
// Serve quote page at /quote?id=123[&token=...]
...
app.use(
  '/quotes',
  makeQuotesRouter(prisma, {
    APP_BASE_URL: process.env.APP_BASE_URL,
    QUOTE_TAX_RATE: process.env.QUOTE_TAX_RATE,
